...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('livewire.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <div class="btn-group">
                <div class="dropdown me-1">
                    ...
                    <div class="dropdown-menu dropdown-menu-end pb-0">
                        ...
                        <a class="dropdown-item d-flex align-items-center fw-bold" href="#">Computer Engineering <svg
                        ...
                        <a class="dropdown-item fw-bold" href="#">ECE</a>
                        <a class="dropdown-item fw-bold rounded-bottom" href="#">EEE</a>
                        <a class="dropdown-item fw-bold rounded-bottom" href="#">ME</a>
                        <a class="dropdown-item fw-bold rounded-bottom" href="#">AI & ML ENGINEERING</a>
                        <a class="dropdown-item fw-bold rounded-bottom" href="#">CCN</a>
                        <a class="dropdown-item fw-bold rounded-bottom" href="#">CIVIL ENGINEERING</a>
                    </div>
                </div>
                <div class="dropdown">
                    <button class="btn btn-link text-dark dropdown-toggle dropdown-toggle-split m-0 p-1"
    ...
    <table class="table user-table table-hover align-items-center">
        <thead>
            <tr>
                ...
                <th class="border-bottom">Pin No.</th>
                <th class="border-bottom">Unique No</th>
                <th class="border-bottom">Hall Ticket No</th>
                <th class="border-bottom">Rank</th>
                <th class="border-bottom">Name</th>
                <th class="border-bottom">Gender</th>
                <th class="border-bottom">Caste</th>
            </tr>
        </thead>
        <tbody>
        @foreach ($companies as $company)
                    <tr>
                        ...
                        <td>{{ $company->caste }}</td>
                        <td>
                            <form action="{{ route('destroy',$company->id) }}" method="Post">
