                    ...
                    <table class="table fixed-column-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img class="card-img-top" src="{{ secure_asset('storage/'.$layout->icon) }}" alt="Card image cap" style="width: 44px; height: 44px;border-radius: 50%"></td>
                                <td>{{ $layout->slug }}</td>
                                <td>
                                    <form action="{{ route('layout.destroy',$layout->id) }}" method="Post">
                                        ...
                                        <div class="btn-group1" style="display: flex; justify-content: end;">
                                            <div style="display:flex; gap:10px;">
                                                <a class="btn btn-primary" href="{{ route('notifications', [ 'tid' =>  $layout->id]) }}"><i class="fa fa-edit btn-hover"></i></a>
