    ...
    <div>
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            ...
            <div>
                ...
                <a href="{{ route('transactions') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <div class="row">
            <div class="col-12 col-xl-8">
                ...
                <div class="card card-body border-0 shadow mb-4">
                    ...
                    <form action="{{ url('layout.store', [], true) }}" id="myform" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="tid" value="{{ $editId }}">
                        <!--  -->
                        <div class="row">
                            <div class="col-md-6">
                                <h2 class="h5 mb-4">Layout</h2>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="Display_in_layout">name:</label>
                                <input type="text" name="Display_in_layout" value="{{ $Display_in_layout }}" class="form-control" placeholder="Name" required>
