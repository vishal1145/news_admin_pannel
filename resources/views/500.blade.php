            ...
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent" style="margin-bottom: auto;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Header News List</li>
                    </ol>
                </nav>
                <h2 class="h4">Header News List</h2>
            </div>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="{{ route('404', [ 'tid' => '-1' ]) }}" class="btn btn-pill btn-outline-primary">
        ...
        <div class="card card-body border-0 shadow mb-4">
            ...
            <div class="row" style="margin-bottom: 36px;">
                <div class="col-md-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <td>{{ $headers->Name }} / {{ $headers->SubCatName }}</td>
                            </p>
                            <div class="E-D-btn">
                                <form action="{{ route('headers.destroy',$headers->id) }}" method="Post">
                                    ...
                                    <div class="btn-group1" style="display: flex; justify-content: end;">
                                        <div style="display:flex; gap:10px;">
                                            <a class="btn btn-primary" href="{{ route('404', [ 'tid' =>  $headers->id]) }}"><i class="fa fa-edit btn-hover"></i></a>
                ...
                <div class="col-md-7" style="max-height: 506px; overflow-y: scroll; text-align: justify;">
                    <td>{!! str_replace('_', ' ', $headers->Content) !!}</td>
                </div>
            </div>
            @endforeach
