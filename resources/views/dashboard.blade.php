                    ...
                    <div class="card border-0 shadow">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h2 class="fs-5 fw-bold mb-0">Page visits & Credentials</h2>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        <th class="border-bottom" scope="col">URL</th>
                                        <th class="border-bottom" scope="col">USERNAME</th>
                                        <th class="border-bottom" scope="col">PASSWORD</th>
                                ...
                                <tbody>
                                    <tr>
                                        <th class="text-gray-900" scope="row">
                                            <a href="https://newspannel.algofolks.com/" class="btn btn-sm btn-secondary d-inline-flex align-items-center" target="_blank">
                                    ...
                                    <tr>
                                        <th class="text-gray-900" scope="row">
                                            <a href="https://news-frontend.algofolks.com/" class="btn btn-sm btn-secondary d-inline-flex align-items-center" target="_blank">
                                                <svg class="icon icon-xxs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path>
                                                </svg>
                                                News frontend
                                    ...
                                    <tr>
                                        <th class="text-gray-900" scope="row">
                                            <a href="https://aligarh.city" class="btn btn-sm btn-secondary d-inline-flex align-items-center" target="_blank">
                                                <svg class="icon icon-xxs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path>
                                                </svg>
                                                Aligarh
                                    ...
                                    <tr>
                                        <th class="text-gray-900" scope="row">
                                            <a href="https://hathras.city" class="btn btn-sm btn-secondary d-inline-flex align-items-center" target="_blank">
                                                <svg class="icon icon-xxs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path>
                                                </svg>
                                                Hathras
