 ...
 */ (function () {
    ...
    makeArray(document.querySelectorAll(".js-sidenav-group")).forEach(function (
        sidenavGroup
    ) {
    ...
    makeArray(document.querySelectorAll(".tooltip-demo")).forEach(function (
        tooltip
    ) {
        new bootstrap.Tooltip(tooltip, { selector: '[data-toggle="tooltip"]' });
    });
    ...
    makeArray(document.querySelectorAll(".toast")).forEach(function (
        toastNode
    ) {
        var toast = new bootstrap.Toast(toastNode, { autohide: false });
        toast.show();
    });
    makeArray(document.querySelectorAll(".tooltip-test")).forEach(function (
        tooltip
    ) {
        new bootstrap.Tooltip(tooltip);
    });
    makeArray(document.querySelectorAll(".popover-test")).forEach(function (
        popover
    ) {
        new bootstrap.Popover(popover);
    });
    ...
    makeArray(document.querySelectorAll('.bd-content [href="#"]')).forEach(
        function (link) {
    ...
    makeArray(document.querySelectorAll(".btn-clipboard")).forEach(function (
        btn
    ) {
...
d.addEventListener("DOMContentLoaded", function (event) {
    ...
    var options = {
        ...
        tooltip: { style: { fontSize: "14px", fontFamily: "Inter" } },
        theme: { monochrome: { enabled: true, color: "#f3c78e" } },
        grid: { show: true, borderColor: "#f5e1c5", strokeDashArray: 1 },
        series: [{ name: "Sales", data: [95, 52, 78, 45, 19, 53, 60] }],
        markers: {
            size: 5,
            strokeColors: "#ffffff",
        ...
        responsive: [{ breakpoint: 768, options: { yaxis: { show: false } } }],
    };
    ...
    var optionsWeeklySalesChart = {
        series: [{ name: "Sales", data: [32, 44, 37, 47, 42, 55, 47, 65] }],
        chart: {
            type: "bar",
            width: "100%",
            height: 260,
        ...
        theme: { monochrome: { enabled: true, color: "#31316A" } },
        plotOptions: {
            bar: {
                columnWidth: "20%",
                borderRadius: 5,
    ...
    var optionsRevenueChart = {
        series: [{ name: "Sales", data: [34, 29, 32, 38, 39, 35, 36] }],
        chart: {
            type: "bar",
            width: "100%",
            height: 140,
    ...
    var optionsTrafficVolumesChart = {
        ...
        dataLabels: { enabled: false },
        stroke: { curve: "smooth" },
        grid: { show: true, borderColor: "#f2f2f2", strokeDashArray: 1 },
        xaxis: {
            categories: [
                "01 Feb",
                "02 Feb",
    ...
    var optionsTrafficShareChart = {
        series: [{ name: "Visits", data: [4, 7, 9, 29, 51] }],
        chart: {
            type: "bar",
            height: 500,
            foreColor: "#4B5563",
        ...
        grid: { show: false, borderColor: "#f2f2f2", strokeDashArray: 1 },
        legend: { show: false },
        ...
        xaxis: {
            ...
            axisBorder: { color: "#ffffff" },
            axisTicks: { color: "#ffffff", offsetY: 5 },
        },
    };
    ...
    var optionsAppRankingChart = {
        series: [
            ...
            { name: "Widgets", data: [76, 85, 101, 98, 87, 105, 91, 114, 94] },
        ],
        chart: {
            type: "bar",
            height: "400px",
        ...
        fill: { opacity: 1 },
        responsive: [
            { breakpoint: 1499, options: { chart: { height: "400px" } } },
        ],
    };
        ...
        new svgMap({
            ...
            data: {
                data: {
                    ...
                    change: { name: "Change by month", format: "{0} %" },
                },
                applyData: "visitors",
                values: {
...
if (d.querySelector(".line-chart-filled")) {
    new Chartist.Line(
        ".line-chart-filled",
        {
            labels: [1, 2, 3, 4, 5, 6, 7, 8],
...
if (document.getElementById("basicAlert")) {
    document
        .getElementById("basicAlert")
        .addEventListener("click", function () {
            Swal.fire("Basic alert", "You clicked the button!");
        });
}
...
var optionsLineChart = {
    ...
    chart: { type: "area", width: "100%", height: 360 },
    theme: { monochrome: { enabled: true, color: "#31316A" } },
    tooltip: {
        fillSeriesColor: false,
        onDatasetHover: { highlightDataSeries: false },
...
var optionsBarChart = {
    series: [{ name: "Sales", data: [34, 29, 32, 38, 39, 35, 36] }],
    chart: { type: "bar", width: "100%", height: 360 },
    theme: { monochrome: { enabled: true, color: "#31316A" } },
    plotOptions: {
        bar: {
            columnWidth: "25%",
